...
template <typename T, size_t Capacity> class SPSCRingCore final
{
  public:
...
// Producer view
// ============================================================================
template <typename T, size_t Capacity> class SPSCRingWriter final
{
  public:
    explicit SPSCRingWriter(SPSCRingCore<T, Capacity> &core) noexcept : core_(core) {}
...
// Consumer view
// ============================================================================
template <typename T, size_t Capacity> class SPSCRingReader final
{
  public:
    explicit SPSCRingReader(SPSCRingCore<T, Capacity> &core) noexcept : core_(core) {}
...
// Convenience wrapper
// ============================================================================
template <typename T, size_t Capacity> class SPSCRing final
{
  public:
