...
struct SPSCRingDropOldestCore final {
...
public:
    ...
    [[nodiscard]] bool push(const T& item) noexcept {
        ...
        const size_t tail = core_.tail_.load(std::memory_order_acquire);
        ...
        if (full) {
            ...
            dropped = core_.tail_.compare_exchange_strong(expected, next_tail,
